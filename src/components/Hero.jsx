  ...
  return (
    ...
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
            Discover the world of virtual reality with ease and speed. This is the most popular video game ever in the world and will be available soon on the web soon enough for you to enjoy it and enjoy your friends with the latest version of virtual reality. This  is the most popular video game ever in the world and will be available soon.
        </p>
